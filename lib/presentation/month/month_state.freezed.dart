...
mixin _$MonthCell {
 ...
 DateTime get date; bool get isCurrentMonth; bool get isToday; bool get isWeekend; bool get isFuture;/// 배지. normal이면 null
...
int get hashCode {
  final _this = this as MonthCell;
  return Object.hash(runtimeType,_this.date,_this.isCurrentMonth,_this.isToday,_this.isWeekend,_this.isFuture,_this.type,_this.value,_this.hasBackground);
}

@override
String toString() {
  final _this = this as MonthCell;
  return 'MonthCell(date: ${_this.date}, isCurrentMonth: ${_this.isCurrentMonth}, isToday: ${_this.isToday}, isWeekend: ${_this.isWeekend}, isFuture: ${_this.isFuture}, type: ${_this.type}, value: ${_this.value}, hasBackground: ${_this.hasBackground})';
}
...
@useResult
$Res call({
 DateTime date, bool isCurrentMonth, bool isToday, bool isWeekend, bool isFuture, WorkType? type, MonthCellValue value, bool hasBackground
});
...
/// Create a copy of MonthCell
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? date = null,Object? isCurrentMonth = null,Object? isToday = null,Object? isWeekend = null,Object? isFuture = null,Object? type = freezed,Object? value = null,Object? hasBackground = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime date,  bool isCurrentMonth,  bool isToday,  bool isWeekend,  bool isFuture,  WorkType? type,  MonthCellValue value,  bool hasBackground)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MonthCell() when $default != null:
return $default(_that.date,_that.isCurrentMonth,_that.isToday,_that.isWeekend,_that.isFuture,_that.type,_that.value,_that.hasBackground);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime date,  bool isCurrentMonth,  bool isToday,  bool isWeekend,  bool isFuture,  WorkType? type,  MonthCellValue value,  bool hasBackground)  $default,) {final _that = this;
switch (_that) {
case _MonthCell():
return $default(_that.date,_that.isCurrentMonth,_that.isToday,_that.isWeekend,_that.isFuture,_that.type,_that.value,_that.hasBackground);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime date,  bool isCurrentMonth,  bool isToday,  bool isWeekend,  bool isFuture,  WorkType? type,  MonthCellValue value,  bool hasBackground)?  $default,) {final _that = this;
switch (_that) {
case _MonthCell() when $default != null:
return $default(_that.date,_that.isCurrentMonth,_that.isToday,_that.isWeekend,_that.isFuture,_that.type,_that.value,_that.hasBackground);case _:
  return null;
...
class _MonthCell implements MonthCell {
  const _MonthCell({required this.date, required this.isCurrentMonth, required this.isToday, required this.isWeekend, required this.isFuture, this.type, required this.value, required this.hasBackground});
...
@override
int get hashCode {
    return Object.hash(runtimeType,date,isCurrentMonth,isToday,isWeekend,isFuture,type,value,hasBackground);
}

@override
String toString() {
    return 'MonthCell(date: $date, isCurrentMonth: $isCurrentMonth, isToday: $isToday, isWeekend: $isWeekend, isFuture: $isFuture, type: $type, value: $value, hasBackground: $hasBackground)';
}
...
/// Create a copy of MonthCell
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? date = null,Object? isCurrentMonth = null,Object? isToday = null,Object? isWeekend = null,Object? isFuture = null,Object? type = freezed,Object? value = null,Object? hasBackground = null,}) {
